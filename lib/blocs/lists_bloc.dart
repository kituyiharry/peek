import 'package:peek/models/lists.dart' as Lists;
...
class ListsBloc{
  ...
  ListsBloc(this._iexApiProxy){
    _gainersListStream  = _iexApiProxy.fetchAList(Lists.MarketListType.GAINERS).asStream();
  }
...
class InfocusListBloc{
  ...
  _infocusListStream = _iexApiProxy.fetchAList(Lists.MarketListType.INFOCUS).asStream();
}
...
class LosersListBloc{
  ...
  LosersListBloc(this._iexApiProxy){
    _losersListStream = _iexApiProxy.fetchAList(Lists.MarketListType.LOSERS).asStream();
  }

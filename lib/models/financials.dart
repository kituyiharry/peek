...
class FinancialsModel {
  ...
  FinancialsModel(this.reportDate, this.grossProfit, this.costOfRevenue, this.operatingRevenue, this.totalRevenue, this.operatingIncome, this.netIncome, this.researchAndDevelopment, this.operatingExpense, this.currentAssets, this.totalAssets, this.totalLiabilities, this.currentCash, this.currentDebt, this.totalCash, this.totalDebt, this.shareHolderEquity, this.cashChange, this.cashFlow);
...
class IncomeModel{
  ...
  IncomeModel(this.operatingIncome, this.netIncome, this.researchAndDevelopment, this.operatingExpense, this.grossProfit, this.costOfRevenue, this.totalRevenue, this.operatingRevenue);
...
class BalanceSheetModel{
  ...
  BalanceSheetModel(this.currentAssets, this.totalAssets, this.currentDebt, this.totalDebt);
...
class SplitModelAdapter {
  ...
  List<IncomeModel> toIncomeStatementModel(){
    return _list.map((f) =>
      IncomeModel.fromFinancialsModel(f)
    ).toList();
  }
